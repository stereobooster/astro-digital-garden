...
prev: false
next: false
description: How to publish digital garden (aka second brain, zettelkasten) with Astro
---
...
Symbols used in sidebar:

- 🧠 - Just an idea. There is no solution, nor specific action
- 🚷 - I know what I want to do, but I don't know how exactly
- 🚧 - I know what I want to do, and I know how to do it. What is left is actually implement it
