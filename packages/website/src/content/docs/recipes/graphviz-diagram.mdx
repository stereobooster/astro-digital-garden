...
Alternatively I can parse dot languge and use alternative renders, for example:

- parsers
  - [ts-graphviz](https://github.com/ts-graphviz/ts-graphviz)
  - [visjs](https://github.com/visjs/vis-network/blob/master/lib/network/dotparser.js)
