...
**Problem**: Links in Starlight (and autogenerated sidebar) connected to the path of file. But in case of difital-gardens one often moves content around, which results in broken links.
